...
class InterimAdmin(ImportExportModelAdmin, admin.ModelAdmin):
    list_display = ('request_id', 'employee_name', 'employee_id', 'reporting_manager', 'num_of_days', 'start_date', 'end_date', 'status')
